...
export default function TechGrid() {
  const tech = [
    { img: "/images/tech1.webp", h: "Software (CMS)", li: ["Steuere alles zentral", "Playlists & Zeitpläne per Klick", "Einfache Benutzerverwaltung"] },
    { img: "/images/tech2.webp", h: "Inhalte", li: ["Bilder, Videos & Webseiten", "Live-Daten (Wetter, News)", "Automatische Updates"] },
    { img: "/images/tech3.webp", h: "Hardware", li: ["Profi-Displays (24/7 Betrieb)", "Hell, robust & langlebig", "Indoor & Outdoor"] },
  ];

  const [lightbox, setLightbox] = useState<string | null>(null);

  return (
    <section id="technik" className="bg-slate-50 py-12 scroll-mt-24">
      <div className="mx-auto max-w-screen-xl px-4 md:px-6">
        <h2 className="mb-3 text-3xl font-black">Technik, die einfach läuft</h2>

        {/* GIF */}
        <div className="rounded-2xl bg-white p-5 shadow">
          <p className="m-0 text-slate-700">
            So einfach funktioniert es: Inhalte hochladen, planen, fertig. Die Technik übernehmen wir.
            Egal ob Cloud oder Lokal – du hast die volle Kontrolle.
          </p>
